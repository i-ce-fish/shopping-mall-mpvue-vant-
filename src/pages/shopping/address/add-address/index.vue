    ...
    <form report-submit="true">
      ...
      <tui-list-cell :arrow="true" padding="0">
        <view class="tui-line-cell">
          ...
          <input placeholder-class="tui-phcolor" class="tui-input" disabled name="city" placeholder="请选择城市"
      ...
      <view class="tui-addr-save">
        <van-button type="danger" custom-style="height:88rpx;width:100%;" >保存收货地址</van-button>
      </view>
      <view class="tui-del tui-flex tui-align-center" v-if="false">
        <van-button custom-style="height:88rpx;width:100%;">删除收货地址</van-button>
      </view>
    </form>
  </view>
</template>
